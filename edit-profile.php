           ...
           <div class="tab-content">
               ...
               <form action="userAccount.php" id="form" method="post" name="form" enctype="multipart/form-data">
                   <form class="form-horizontal" role="form">
                       ...
                       <div class="form-group">
                           <label for="inputgame_page_url" class="col-lg-2 control-label">Game Page URL</label>
                           <div class="col-lg-10">
                               <input type="text" name="game_page_url" class="form-control" id="inputgame_page_url" placeholder="Page embed URL" value="<?php echo !empty($userData['game_page_url'])?$userData['game_page_url']:''; ?>">
                           </div>
                       </div>
                        <div class="form-group">
