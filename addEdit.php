                ...
                <form method="post" action="postAction.php" enctype="multipart/form-data">
                    <div class="form-group">
                        ...
                        <select name="category" class="form-control">
                            <option value="action" <?php echo !empty($imgData['category']) && $imgData['category'] == 'action'?'selected="selected"':''; ?> >Action</option>
                            <option value="adventure" <?php echo !empty($imgData['category']) && $imgData['category'] == 'adventure'?'selected="selected"':''; ?>>Adventure</option>
                            <option value="education" <?php echo !empty($imgData['category']) && $imgData['category'] == 'education'?'selected="selected"':''; ?>>Education</option>
                            <option value="role_play" <?php echo !empty($imgData['category']) && $imgData['category'] == 'role_play'?'selected="selected"':''; ?>>Role Play</option>
                            <option value="simulation" <?php echo !empty($imgData['category']) && $imgData['category'] == 'simulation'?'selected="selected"':''; ?>>Simulation</option>
                            <option value="sports" <?php echo !empty($imgData['category']) && $imgData['category'] == 'sports'?'selected="selected"':''; ?>>Sports</option>
                        </select>
                    </div>
                    <div class="form-group">
                        <label>Image</label>
